...
void * creationFils(void * arg){
    ...
    int tunnelPere;
    int tunnelFils;
    tunnelFils = pipe(tunnel[argumentsActuels->trains.ensTrain[argumentsActuels->trains.nbtrains].numtrain]); // Il faut que cette ligne soit impérativement placée avant le fork
